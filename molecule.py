...
class Reaction:
    ...
    def __parse_reaction(self):
        ...
        assert re.search(r'<?=>?', self.reaction) != None
        ...
        keyList.sort()
        #computes the homogenous system of linear equations matrix to be solved
...
molecules = ['CH4', 'H2SO4', 'H2O', 'CO2', 'NH4OH', 'K4[Fe(CN)6]',
         ...
         'NaBr', 'PbSO4', 'Ca(OH)2', 'Na3PO4', '(NH4)2CO3', 'C6H12O6', 'NH4ClO4', 
         'Fe3(PO4)2', '(NH4)2S', 'Zn(C2H3O2)2', 'AgF', 'ClO4^-', 'SO4^2-', 'CO3^-2', 'NH4^+',
         'MnO3', 'C6CH3(NO2)2H2', 'Fe3[Co(NH3)6((SiO4))(Dmg)]2^3+*5Ca(SO4)65']

##for t in molecules:
##    a = Molecule(t)
##    print(a.name, a.count, a.mass)

equations = ['Fe + Cl2 = FeCl3',
             'He + SO4 = SO3 + O2',
